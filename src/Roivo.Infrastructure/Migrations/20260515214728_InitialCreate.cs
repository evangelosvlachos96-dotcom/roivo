        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AadeUserId = table.Column<string>(type: "text", nullable: true),
                    AadeSubscriptionKeyEncrypted = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Psd2AccessTokenEncrypted = table.Column<string>(type: "text", nullable: true),
                    Psd2TokenExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    BusinessId = table.Column<Guid>(type: "uuid", nullable: false),
                    AadeMark = table.Column<string>(type: "text", nullable: false),
                    AadeUid = table.Column<string>(type: "text", nullable: true),
                    AadeQrUrl = table.Column<string>(type: "text", nullable: true),
                    Direction = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    InvoiceType = table.Column<string>(type: "text", nullable: false),
                    Series = table.Column<string>(type: "text", nullable: true),
                    Number = table.Column<int>(type: "integer", nullable: false),
                    IssueDate = table.Column<DateOnly>(type: "date", nullable: false),
                    CounterpartyAfm = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankTransactions_TenantId_BookingDate",
                table: "BankTransactions",
                columns: new[] { "TenantId", "BookingDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Businesses_TenantId_Afm",
                table: "Businesses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_TenantId_AadeMark",
                table: "Invoices",
                columns: new[] { "TenantId", "AadeMark" },
                unique: true);
